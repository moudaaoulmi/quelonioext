...
import br.pucrio.inf.les.genarch.models.configuration.provider.ConfigurableElementItemProvider;
...
/**
 * This is the item provider adapter for a {@link br.pucrio.inf.les.genarch.extension.mas.Capability} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CapabilityItemProvider
	extends ConfigurableElementItemProvider
	implements	
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DsamtypesPackage.Literals.TEMPLATES_IMPL__ASSOCIATED_TEMPLATES);
			childrenFeatures.add(DsamtypesPackage.Literals.FRAGMENTS_IMPL__ASSOCIATED_FRAGMENTS);
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DsamtypesPackage.Literals.TEMPLATES_IMPL__ASSOCIATED_TEMPLATES,
				 ImplementationFactory.eINSTANCE.createImplementationTemplate()));

		newChildDescriptors.add
			(createChildParameter
				(DsamtypesPackage.Literals.FRAGMENTS_IMPL__ASSOCIATED_FRAGMENTS,
