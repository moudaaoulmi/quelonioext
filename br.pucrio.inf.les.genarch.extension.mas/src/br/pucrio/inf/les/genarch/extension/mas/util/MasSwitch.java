...
public class MasSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case MasPackage.AGENT: {
				...
				if (result == null) result = caseConfigurableElement(agent);
				if (result == null) result = caseTemplatesImpl(agent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MasPackage.CAPABILITY: {
				...
				if (result == null) result = caseConfigurableElement(capability);
				if (result == null) result = caseTemplatesImpl(capability);
				if (result == null) result = caseFragmentsImpl(capability);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MasPackage.PLAN: {
				...
				if (result == null) result = caseClassesImpl(plan);
				if (result == null) result = caseFragmentsImpl(plan);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MasPackage.GOAL: {
				...
				if (result == null) result = caseFragmentsImpl(goal);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MasPackage.EVENT: {
				...
				if (result == null) result = caseFragmentsImpl(event);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MasPackage.BELIEF: {
				...
				if (result == null) result = caseClassesImpl(belief);
				if (result == null) result = caseFragmentsImpl(belief);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MasPackage.EXPRESSION: {
				...
				if (result == null) result = caseFragmentsImpl(expression);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Templates Impl</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Templates Impl</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTemplatesImpl(TemplatesImpl object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Fragments Impl</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Fragments Impl</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseFragmentsImpl(FragmentsImpl object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Classes Impl</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Classes Impl</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseClassesImpl(ClassesImpl object) {
		return null;
	}
