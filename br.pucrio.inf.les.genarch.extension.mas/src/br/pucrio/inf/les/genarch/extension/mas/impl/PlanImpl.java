 ...
 * <ul>
 *   <li>{@link br.pucrio.inf.les.genarch.extension.mas.impl.PlanImpl#getAssociatedFragments <em>Associated Fragments</em>}</li>
 *   <li>{@link br.pucrio.inf.les.genarch.extension.mas.impl.PlanImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PlanImpl extends ClassesImplImpl implements Plan {
	/**
	...
	public EList<ImplementationFragment> getAssociatedFragments() {
		if (associatedFragments == null) {
			associatedFragments = new EObjectContainmentEList<ImplementationFragment>(ImplementationFragment.class, this, MasPackage.PLAN__ASSOCIATED_FRAGMENTS);
		}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MasPackage.PLAN__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MasPackage.PLAN__ASSOCIATED_FRAGMENTS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == FragmentsImpl.class) {
			switch (derivedFeatureID) {
				case MasPackage.PLAN__ASSOCIATED_FRAGMENTS: return DsamtypesPackage.FRAGMENTS_IMPL__ASSOCIATED_FRAGMENTS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == FragmentsImpl.class) {
			switch (baseFeatureID) {
				case DsamtypesPackage.FRAGMENTS_IMPL__ASSOCIATED_FRAGMENTS: return MasPackage.PLAN__ASSOCIATED_FRAGMENTS;
				default: return -1;
			}
		}
