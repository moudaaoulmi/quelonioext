...
/**
 * This is the item provider adapter for a {@link br.pucrio.inf.les.genarch.models.configuration.Configuration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConfigurationItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ConfigurationPackage.Literals.CONFIGURATION__MAPPING_RELATIONSHIPS);
			childrenFeatures.add(ConfigurationPackage.Literals.CONFIGURATION__DSM_MAPPINGS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ConfigurationPackage.Literals.CONFIGURATION__MAPPING_RELATIONSHIPS,
				 ConfigurationFactory.eINSTANCE.createMappingRelationships()));

		newChildDescriptors.add
			(createChildParameter
				(ConfigurationPackage.Literals.CONFIGURATION__DSM_MAPPINGS,
				 ConfigurationFactory.eINSTANCE.createDSMMappings()));
	}
