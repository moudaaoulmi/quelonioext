...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Intra Dependence</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link br.pucrio.inf.les.genarch.models.dsamtypes.impl.IntraDependenceImpl#getDependences <em>Dependences</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class IntraDependenceImpl extends DependenceRelationshipImpl implements IntraDependence {
	/**
	...
	protected EClass eStaticClass() {
		return DsamtypesPackage.Literals.INTRA_DEPENDENCE;
	}
		...
		if (dependences != null && dependences.eIsProxy()) {
			...
			if (dependences != oldDependences) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DsamtypesPackage.INTRA_DEPENDENCE__DEPENDENCES, oldDependences, dependences));
			}
		}
		return dependences;
	}
	...
	public void setDependences(DomainElement newDependences) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DsamtypesPackage.INTRA_DEPENDENCE__DEPENDENCES, oldDependences, dependences));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DsamtypesPackage.INTRA_DEPENDENCE__DEPENDENCES:
