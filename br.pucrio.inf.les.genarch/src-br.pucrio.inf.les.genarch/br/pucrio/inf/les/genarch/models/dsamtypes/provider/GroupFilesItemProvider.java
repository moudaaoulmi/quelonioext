...
/**
 * This is the item provider adapter for a {@link br.pucrio.inf.les.genarch.models.dsamtypes.GroupFiles} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GroupFilesItemProvider
	 ...
	 * @generated
	 */
	public GroupFilesItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((GroupFiles)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_GroupFiles_type") :
			getString("_UI_GroupFiles_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(GroupFiles.class)) {
