...
public class DsamtypesPackageImpl extends EPackageImpl implements DsamtypesPackage {
	...
	public void initializePackageContents() {
		...
		// Create annotations
		// XMLTag
		createXMLTagAnnotations();
		// JavaAnnotation
		createJavaAnnotationAnnotations();
	}

	/**
	 * Initializes the annotations for <b>XMLTag</b>.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void createXMLTagAnnotations() {
		String source = "XMLTag";		
		addAnnotation
		  (this, 
		   source, 
		   new String[] {
	...
	/**
	 * Initializes the annotations for <b>JavaAnnotation</b>.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void createJavaAnnotationAnnotations() {
		String source = "JavaAnnotation";			
		addAnnotation
		  (this, 
		   source, 
		   new String[] {
