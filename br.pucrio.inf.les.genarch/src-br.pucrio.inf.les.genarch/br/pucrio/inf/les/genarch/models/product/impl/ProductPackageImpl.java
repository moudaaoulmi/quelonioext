...
public class ProductPackageImpl extends EPackageImpl implements ProductPackage {
	 ...
	 * @generated
	 */
	public EAttribute getProductFragment_Name() {
	...
	public EAttribute getProductFragment_Content() {
		return (EAttribute)productFragmentEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(productFragmentEClass, PRODUCT_FRAGMENT__NAME);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getProductFragment_Name(), ecorePackage.getEString(), "name", "", 0, 1, ProductFragment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
