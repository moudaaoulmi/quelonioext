...
public class FeaturePackageImpl extends EPackageImpl implements FeaturePackage {
	 ...
	 * @see br.pucrio.inf.les.genarch.models.feature.FeaturePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EAttribute getFeature_Path() {
	...
	public void createPackageContents() {
		...
		createEAttribute(featureEClass, FEATURE__PATH);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getFeature_Path(), ecorePackage.getEString(), "path", null, 0, 1, Feature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEEnumLiteral(featureTypeEEnum, FeatureType.OPTIONAL_LITERAL);
		addEEnumLiteral(featureTypeEEnum, FeatureType.MANDATORY_LITERAL);
		addEEnumLiteral(featureTypeEEnum, FeatureType.ALTERNATIVE_LITERAL);
