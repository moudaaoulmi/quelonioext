...
/**
 * This is the item provider adapter for a {@link br.pucrio.inf.les.genarch.models.dsamtypes.GroupTemplates} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GroupTemplatesItemProvider
	 ...
	 * @generated
	 */
	public GroupTemplatesItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((GroupTemplates)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_GroupTemplates_type") :
			getString("_UI_GroupTemplates_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(GroupTemplates.class)) {
