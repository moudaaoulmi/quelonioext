...
/**
 * This is the item provider adapter for a {@link br.pucrio.inf.les.genarch.models.dsamtypes.GroupComponents} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GroupComponentsItemProvider
	 ...
	 * @generated
	 */
	public GroupComponentsItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((GroupComponents)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_GroupComponents_type") :
			getString("_UI_GroupComponents_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(GroupComponents.class)) {
