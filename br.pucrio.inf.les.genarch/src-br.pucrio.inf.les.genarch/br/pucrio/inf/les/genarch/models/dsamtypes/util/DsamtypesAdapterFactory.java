...
public class DsamtypesAdapterFactory extends AdapterFactoryImpl {
	...
	protected DsamtypesSwitch<Adapter> modelSwitch =
		new DsamtypesSwitch<Adapter>() {
			...
			@Override
			public Adapter caseExtraDependence(ExtraDependence object) {
				return createExtraDependenceAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link br.pucrio.inf.les.genarch.models.dsamtypes.ExtraDependence <em>Extra Dependence</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
