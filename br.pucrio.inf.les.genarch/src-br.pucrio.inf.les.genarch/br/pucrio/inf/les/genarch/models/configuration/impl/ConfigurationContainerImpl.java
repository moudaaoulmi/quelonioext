...
public class ConfigurationContainerImpl extends EObjectImpl implements ConfigurationContainer {
	 ...
	 * @ordered
	 */
	protected EList<ConfigurationComponent> components;
	 ...
	 * @generated
	 */
	public EList<ConfigurationComponent> getComponents() {
		if (components == null) {
			components = new EObjectContainmentEList<ConfigurationComponent>(ConfigurationComponent.class, this, ConfigurationPackage.CONFIGURATION_CONTAINER__COMPONENTS);
		}
		return components;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ConfigurationPackage.CONFIGURATION_CONTAINER__COMPONENTS:
				getComponents().clear();
				getComponents().addAll((Collection<? extends ConfigurationComponent>)newValue);
				return;
		}
