...
public class DsamtypesFactoryImpl extends EFactoryImpl implements DsamtypesFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case DsamtypesPackage.INTRA_DEPENDENCE: return createIntraDependence();
			case DsamtypesPackage.EXTRA_DEPENDENCE: return createExtraDependence();
	 ...
	 * @generated
	 */
	public IntraDependence createIntraDependence() {
		IntraDependenceImpl intraDependence = new IntraDependenceImpl();
		return intraDependence;
	}
	 ...
	 * @generated
	 */
	public ExtraDependence createExtraDependence() {
		ExtraDependenceImpl extraDependence = new ExtraDependenceImpl();
