...
public class ConfigureDomainElementWizardPage extends WizardPage {
	...
	public ConfigureDomainElementWizardPage(IFile modelFile,EObject element) {
		super("wizardPage");
	...
	public void addFeatureModel() {
		...
		if ( element instanceof ArchitectureEntity ) {
			String entityPath = ((ArchitectureEntity)element).getPath();
