...
public class ConfigureElementWizard extends Wizard implements INewWizard {
	...
	public ConfigureElementWizard(IFile modelFile, EObject element) {
		super();
	...
	public void addPages() {
		this.page = new ConfigureElementWizardPage(modelFile,element);
		...
		if ( configurableElement != null ) {
			...
			for ( Adapter adapter : adapters ) {
				if ( adapter instanceof ItemProviderAdapter ) {
					...
					eElement.setImageURI(((URL)itemProviderAdapter.getImage(configurableElement)).getFile());
				}
			}
