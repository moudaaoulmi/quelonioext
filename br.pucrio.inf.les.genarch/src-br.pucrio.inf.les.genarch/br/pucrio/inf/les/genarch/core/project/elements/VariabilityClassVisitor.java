...
public class VariabilityClassVisitor extends ASTVisitor {
	
	private List<MethodDeclaration> abstractMethodsDeclaration;
	
	public VariabilityClassVisitor() {
	...
	public void setAbstractMethodsDeclaration(final List<MethodDeclaration> abstractMethodsDeclaration) {
		this.abstractMethodsDeclaration = abstractMethodsDeclaration;
	}
