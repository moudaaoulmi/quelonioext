...
public class AbstractClassTemplate
{
	...
	public static synchronized AbstractClassTemplate create(final String lineSeparator)
	{
		nl = lineSeparator;
		final AbstractClassTemplate result = new AbstractClassTemplate();
		nl = null;
		return result;
	}
	...
	protected final String TEXT_2 = ";" + this.NL + "" + this.NL + "public class �attribute� extends ";
