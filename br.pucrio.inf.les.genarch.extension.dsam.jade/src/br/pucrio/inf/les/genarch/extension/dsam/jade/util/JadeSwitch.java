...
public class JadeSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case JadePackage.JADE: {
				Jade jade = (Jade)theEObject;
				T result = caseJade(jade);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JadePackage.AGENT: {
				Agent agent = (Agent)theEObject;
				T result = caseAgent(agent);
				if (result == null) result = caseGroupClass(agent);
			...
			case JadePackage.BEHAVIOR: {
				Behavior behavior = (Behavior)theEObject;
				T result = caseBehavior(behavior);
				if (result == null) result = caseGroupClass(behavior);
				if (result == null) result = caseVariableElement(behavior);
				if (result == null) result = caseGroupRelationship(behavior);
				if (result == null) result = caseDomainElement(behavior);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Jade</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Jade</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseJade(Jade object) {
		return null;
	}
