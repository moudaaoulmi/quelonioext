...
/**
 * This is the item provider adapter for a {@link br.pucrio.inf.les.genarch.extension.dsam.springdm.Bean} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BeanItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SpringdmPackage.Literals.BEAN__VARIANTS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Bean.class)) {
			case SpringdmPackage.BEAN__VARIANTS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SpringdmPackage.Literals.BEAN__VARIANTS,
				 SpringdmFactory.eINSTANCE.createBeanVariant()));
	}
