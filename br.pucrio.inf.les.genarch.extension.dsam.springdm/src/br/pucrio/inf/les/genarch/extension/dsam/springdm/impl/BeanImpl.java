 ...
 * <ul>
 *   <li>{@link br.pucrio.inf.les.genarch.extension.dsam.springdm.impl.BeanImpl#getVariants <em>Variants</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BeanImpl extends GroupClassImpl implements Bean {
	...
	protected EClass eStaticClass() {
		return SpringdmPackage.Literals.BEAN;
	}
	...
	public EList<BeanVariant> getVariants() {
		if (variants == null) {
			variants = new EObjectContainmentEList<BeanVariant>(BeanVariant.class, this, SpringdmPackage.BEAN__VARIANTS);
		}
		return variants;
	}
