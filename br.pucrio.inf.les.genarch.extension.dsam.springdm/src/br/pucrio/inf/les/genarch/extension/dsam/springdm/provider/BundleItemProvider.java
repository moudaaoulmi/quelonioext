...
/**
 * This is the item provider adapter for a {@link br.pucrio.inf.les.genarch.extension.dsam.springdm.Bundle} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BundleItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SpringdmPackage.Literals.BUNDLE__CONTENTS);
			childrenFeatures.add(SpringdmPackage.Literals.BUNDLE__REQUIRE_BUNDLE);
			childrenFeatures.add(SpringdmPackage.Literals.BUNDLE__BEANS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SpringdmPackage.Literals.BUNDLE__CONTENTS,
				 SpringdmFactory.eINSTANCE.createBundleContents()));

		newChildDescriptors.add
			(createChildParameter
				(SpringdmPackage.Literals.BUNDLE__REQUIRE_BUNDLE,
				 SpringdmFactory.eINSTANCE.createRequireBundle()));

		newChildDescriptors.add
			(createChildParameter
				(SpringdmPackage.Literals.BUNDLE__BEANS,
				 SpringdmFactory.eINSTANCE.createBeans()));
	}
