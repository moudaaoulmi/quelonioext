 ...
 * <ul>
 *   <li>{@link br.pucrio.inf.les.genarch.extension.dsam.springdm.impl.BeansImpl#getBeans <em>Beans</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BeansImpl extends EObjectImpl implements Beans {
	...
	protected EClass eStaticClass() {
		return SpringdmPackage.Literals.BEANS;
	}
	...
	public EList<Bean> getBeans() {
		if (beans == null) {
			beans = new EObjectContainmentEList<Bean>(Bean.class, this, SpringdmPackage.BEANS__BEANS);
		}
		return beans;
	}
