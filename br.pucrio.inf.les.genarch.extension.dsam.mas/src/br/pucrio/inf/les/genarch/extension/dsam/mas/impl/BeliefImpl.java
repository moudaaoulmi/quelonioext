 ...
 * <ul>
 *   <li>{@link br.pucrio.inf.les.genarch.extension.dsam.mas.impl.BeliefImpl#getFragments <em>Fragments</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class BeliefImpl extends VariableElementImpl implements Belief {
	/**
	...
	public EList<ImplementationFragment> getFragments() {
		if (fragments == null) {
			fragments = new EObjectContainmentEList<ImplementationFragment>(ImplementationFragment.class, this, MasPackage.BELIEF__FRAGMENTS);
		}
		return fragments;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MasPackage.BELIEF__FRAGMENTS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == GroupFragments.class) {
			switch (derivedFeatureID) {
				case MasPackage.BELIEF__FRAGMENTS: return DsamtypesPackage.GROUP_FRAGMENTS__FRAGMENTS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == GroupFragments.class) {
			switch (baseFeatureID) {
				case DsamtypesPackage.GROUP_FRAGMENTS__FRAGMENTS: return MasPackage.BELIEF__FRAGMENTS;
				default: return -1;
			}
		}
