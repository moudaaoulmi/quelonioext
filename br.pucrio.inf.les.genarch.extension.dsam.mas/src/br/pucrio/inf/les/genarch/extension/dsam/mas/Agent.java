 ...
 * <ul>
 *   <li>{@link br.pucrio.inf.les.genarch.extension.dsam.mas.Agent#getCapabilities <em>Capabilities</em>}</li>
 *   <li>{@link br.pucrio.inf.les.genarch.extension.dsam.mas.Agent#getGoals <em>Goals</em>}</li>
 *   <li>{@link br.pucrio.inf.les.genarch.extension.dsam.mas.Agent#getBelieves <em>Believes</em>}</li>
 *   <li>{@link br.pucrio.inf.les.genarch.extension.dsam.mas.Agent#getPlans <em>Plans</em>}</li>
 *   <li>{@link br.pucrio.inf.les.genarch.extension.dsam.mas.Agent#getEvents <em>Events</em>}</li>
 *   <li>{@link br.pucrio.inf.les.genarch.extension.dsam.mas.Agent#getExpressions <em>Expressions</em>}</li>
 * </ul>
 * </p>
 *
 * @see br.pucrio.inf.les.genarch.extension.dsam.mas.MasPackage#getAgent()
 * @model
 * @generated
 */
public interface Agent extends VariableElement, GroupTemplates, GroupComponents, GroupFiles {
	 ...
	 * @see br.pucrio.inf.les.genarch.extension.dsam.mas.MasPackage#getAgent_Capabilities()
	 ...
	 * @see br.pucrio.inf.les.genarch.extension.dsam.mas.MasPackage#getAgent_Goals()
	 * @model containment="true"
	 * @generated
	 */
	EList<Goal> getGoals();
	 ...
	 * @see br.pucrio.inf.les.genarch.extension.dsam.mas.MasPackage#getAgent_Believes()
	 * @model containment="true"
	 * @generated
	 */
	 ...
	 * @see br.pucrio.inf.les.genarch.extension.dsam.mas.MasPackage#getAgent_Plans()
	 * @model containment="true"
	 * @generated
	 */
	EList<Plan> getPlans();
	 ...
	 * @see br.pucrio.inf.les.genarch.extension.dsam.mas.MasPackage#getAgent_Events()
	 * @model containment="true"
	 * @generated
	 */
	 ...
	 * @see br.pucrio.inf.les.genarch.extension.dsam.mas.MasPackage#getAgent_Expressions()
	 * @model containment="true"
	 * @generated
	 */
