 ...
 *   <li>{@link br.pucrio.inf.les.genarch.extension.dsam.mas.impl.CapabilityImpl#getEvents <em>Events</em>}</li>
 *   <li>{@link br.pucrio.inf.les.genarch.extension.dsam.mas.impl.CapabilityImpl#getExpressions <em>Expressions</em>}</li>
 *   <li>{@link br.pucrio.inf.les.genarch.extension.dsam.mas.impl.CapabilityImpl#getCapabilities <em>Capabilities</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class CapabilityImpl extends VariableElementImpl implements Capability {
	/**
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == GroupTemplates.class) {
			switch (derivedFeatureID) {
				case MasPackage.CAPABILITY__TEMPLATES: return DsamtypesPackage.GROUP_TEMPLATES__TEMPLATES;
				default: return -1;
			}
		}
