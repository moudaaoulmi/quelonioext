 ...
 * <ul>
 *   <li>{@link br.pucrio.inf.les.genarch.extension.dsam.mas.impl.EventImpl#getFragments <em>Fragments</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class EventImpl extends VariableElementImpl implements Event {
	/**
	...
	protected EClass eStaticClass() {
		return MasPackage.Literals.EVENT;
	}
	...
	public EList<ImplementationFragment> getFragments() {
		if (fragments == null) {
			fragments = new EObjectContainmentEList<ImplementationFragment>(ImplementationFragment.class, this, MasPackage.EVENT__FRAGMENTS);
		}
		return fragments;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MasPackage.EVENT__FRAGMENTS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == GroupFragments.class) {
			switch (derivedFeatureID) {
				case MasPackage.EVENT__FRAGMENTS: return DsamtypesPackage.GROUP_FRAGMENTS__FRAGMENTS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == GroupFragments.class) {
			switch (baseFeatureID) {
				case DsamtypesPackage.GROUP_FRAGMENTS__FRAGMENTS: return MasPackage.EVENT__FRAGMENTS;
				default: return -1;
			}
		}
