...
/**
 * This is the item provider adapter for a {@link br.pucrio.inf.les.genarch.extension.dsam.spring.Bean} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BeanItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SpringPackage.Literals.BEAN__VARIANTS);
			childrenFeatures.add(SpringPackage.Literals.BEAN__INTERFACE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SpringPackage.Literals.BEAN__VARIANTS,
				 SpringFactory.eINSTANCE.createBeanVariant()));

		newChildDescriptors.add
			(createChildParameter
				(SpringPackage.Literals.BEAN__INTERFACE,
				 SpringFactory.eINSTANCE.createInterface()));
	}
